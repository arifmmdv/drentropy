<div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
    <a href="/blogs/{{$blog->slug}}" class="card-img-top hover-effect-30 rounded-16 overflow-hidden">
    ...
    <div class="card-body">
        ...
        <div class="left">
            <div class="mb-2">
                <a href="{{$blog->category->slug}}" class="badge bg-2 fs-8">{{$blog->category->name}}</a>
            </div>
