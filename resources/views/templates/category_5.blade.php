        ...
        <div class="container">
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb list-unstyled d-flex flex-row gap-2 align-items-center m-0 ps-0 py-4">
                            ...
                            <li class="breadcrumb-item active text-dark fs-7" aria-current="page">Trends</li>
                        </ul>
                    </nav>
                </div>
            </div>
            <div class="row align-items-end">
                <div class="col-lg-6 col-12">
                    <div class="title">
                        <h4 class="mb-0 ds-4">
                            <span class="text-anime-style-2"> Trends </span>
        ...
        <div class="container">
            <div class="row mt-4 g-4">
                ...
                <div class="col-12">
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        <a href="single-3.html" class="card-img-top hover-effect-30 rounded-16 overflow-hidden">
                            <img src="/assets/imgs/page/img-1.png" alt="magzin" class="cover-image">
                        </a>
                        <div class="card-body">
                            ...
                            <div class="left">
                                <div class="mb-2">
                                    <a href="#" class="badge bg-1 fs-8">Music</a>
                                </div>
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Evolution of Modern Art: Trends Shaping the Creative World</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of major fashion capitals.</p>
                ...
                <div class="col-12">
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        <a href="single-3.html" class="card-img-top hover-effect-30 rounded-16 overflow-hidden">
                            <img src="/assets/imgs/page/img-4.png" alt="magzin" class="cover-image">
                        </a>
                        <div class="card-body">
                            <div class="card-corner">
                                <a href="single-3.html" class="arrow-box">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Power of Photography: Capturing Moments That Matter</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of major fashion capitals.</p>
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="@@link-author" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle" src="/assets/imgs/template/author/author-14.png" alt="magzin">
                                        <span class="fs-7 text-dark fw-regular">Esther Howard</span>
                                    </a>
                                    <ul class="d-flex align-items-center gap-4 text-600 m-0 ps-3">
                                        <li>
                                            <p class="fs-8 m-0">Jun 13, 2025</p>
                ...
                <div class="col-lg-8 col-12 mx-lg-auto">
                    <div class="block-ads bg-200">
                        <div class="banner-ads" data-background="assets/imgs/page/bg-archive1.png">
                            <img src="/assets/imgs/template/logo/logo-gradient-sm.svg" alt="magzin">
                            <h4 class="mt-3 fs-5">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-lg-4 gap-3">
                                <div class="tag-ads">
                                    ...
                                    <div class="tag-ads__content">
                                        <h6 class="fw-medium fs-7 m-0">Google</h6>
                                        <p class="fs-10 m-0">PageSpeed Insidghts</p>
                                    </div>
                                </div>
                                <div class="tag-ads">
                                    <img src="/assets/imgs/template/icons/icon-2.svg" alt="magzin">
                                    <div class="tag-ads__content">
                                        <h6 class="fw-medium fs-7 m-0">Core Web Vitals</h6>
                                        <p class="fs-10 m-0">Assessment Passed</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mt-2 g-4">
                ...
                <div class="col-12">
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        <a href="single-3.html" class="card-img-top hover-effect-30 rounded-16 overflow-hidden">
                            <img src="/assets/imgs/page/img-109.png" alt="magzin" class="cover-image">
                        </a>
                        <div class="card-body">
                            <div class="card-corner">
                                <a href="single-3.html" class="arrow-box">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">Music and Mental Health: The Healing Power of Sound</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of major fashion capitals.</p>
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="@@link-author" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle" src="/assets/imgs/template/author/author-4.png" alt="magzin">
                                        <span class="fs-7 text-dark fw-regular">Guy Hawkins</span>
                                    </a>
                                    <ul class="d-flex align-items-center gap-4 text-600 m-0 ps-3">
                                        <li>
                                            <p class="fs-8 m-0">Jun 13, 2025</p>
                ...
                <div class="col-12">
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        <a href="single-3.html" class="card-img-top hover-effect-30 rounded-16 overflow-hidden">
                            <img src="/assets/imgs/page/img-110.png" alt="magzin" class="cover-image">
                        </a>
                        <div class="card-body">
                            <div class="card-corner">
                                <a href="single-3.html" class="arrow-box">
                            ...
                            <div class="left">
                                <div class="mb-2">
                                    <a href="#" class="badge bg-5 fs-8">Painting</a>
                                </div>
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">How Social Media is Changing the Entertainment Industry</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of major fashion capitals.</p>
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="@@link-author" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle" src="/assets/imgs/template/author/author-5.png" alt="magzin">
                                        <span class="fs-7 text-dark fw-regular">Marvin McKinney</span>
                                    </a>
                                    <ul class="d-flex align-items-center gap-4 text-600 m-0 ps-3">
                                        <li>
                                            <p class="fs-8 m-0">Jun 13, 2025</p>
                ...
                <div class="col-12">
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        <a href="single-3.html" class="card-img-top hover-effect-30 rounded-16 overflow-hidden">
                            <img src="/assets/imgs/page/img-111.png" alt="magzin" class="cover-image">
                        </a>
                        <div class="card-body">
                            <div class="card-corner">
                                <a href="single-3.html" class="arrow-box">
                            ...
                            <div class="left">
                                <div class="mb-2">
                                    <a href="#" class="badge bg-5 fs-8">Film</a>
                                </div>
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Power of Photography: Capturing Moments That Matter</h4>
                                </a>
                                ...
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="@@link-author" class="author d-flex align-items-center gap-2">
                                        ...
                                        <span class="fs-7 text-dark fw-regular">Jerome Bell</span>
                                    </a>
                                    <ul class="d-flex align-items-center gap-4 text-600 m-0 ps-3">
                                        <li>
                                            <p class="fs-8 m-0">Jun 13, 2025</p>
                ...
                <div class="col-12">
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                <div class="mb-2">
                                    <a href="#" class="badge bg-2 fs-8">Trends</a>
                                </div>
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Future of Live Music: Virtual Concerts and Beyond</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of major fashion capitals.</p>
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="@@link-author" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle" src="/assets/imgs/template/author/author-18.png" alt="magzin">
                                        <span class="fs-7 text-dark fw-regular">Leslie Alexander</span>
                                    </a>
                                    <ul class="d-flex align-items-center gap-4 text-600 m-0 ps-3">
                                        <li>
                                            <p class="fs-8 m-0">Jun 13, 2025</p>
