...
@section('content')
        ...
        <div class="container">
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb list-unstyled d-flex flex-row gap-2 align-items-center m-0 ps-0 py-4">
                            ...
                            <li class="breadcrumb-item active text-dark fs-7" aria-current="page">Home & Living</li>
                        </ul>
                    </nav>
                </div>
            </div>
            <div class="row align-items-end">
                <div class="col-lg-6 col-12">
                    <div class="title">
                        <h4 class="mb-0 ds-4">
                            <span class="text-anime-style-2"> Home & Living </span>
    ...
    <!--Home 2 Section 1-->
    <section class="sec-1-home-2 sec-padding bg-50 pt-0 pb-2" data-background="assets/imgs/page/bg-home1-sec1.png">
        <div class="container">
                        ...
                        <div class="hover-effect-1">
                            <div class="card-img-top thumbnail">
                                <a href="single-3.html">
                                    <img src="/assets/imgs/page/img-28.png" alt="magzin" class="cover-image">
                                </a>
                        ...
                        <div class="card-body hover-up">
                            ...
                            <div class="left pe-5">
                                <a href="single-3.html" class="hover-underline">
                                    <h5 class="card-title mb-0 text-truncate-2">Travel Far, Spend Less: Budget Destinations for 2025</h5>
                                </a>
                            ...
                            <div class="article card-5">
                                <div class="post-link">
                                    <div class="hover-effect-1">
                                        <div class="position-relative card-img-top thumbnail">
                                            <a href="single-3.html">
                                                <img src="/assets/imgs/page/img-49.png" alt="magzin" class="cover-image">
                                            </a>
                                ...
                                <div class="card-body mt-4">
                                    <a href="single-3.html" class="hover-underline">
                                        <h6 class="card-title mb-0">Conscious Consumerism: Making Better Choices</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="article card-5">
                                <div class="post-link">
                                    <div class="hover-effect-1">
                                        <div class="position-relative card-img-top thumbnail">
                                            <a href="single-3.html">
                                                <img src="/assets/imgs/page/img-29.png" alt="magzin" class="cover-image">
                                            </a>
                                ...
                                <div class="card-body mt-4">
                                    <a href="single-3.html" class="hover-underline">
                                        <h6 class="card-title mb-0">The Quiet Power of Present Living</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="article card-5">
                                <div class="post-link">
                                    <div class="hover-effect-1">
                                        <div class="position-relative card-img-top thumbnail">
                                            <a href="single-3.html">
                                                <img src="/assets/imgs/page/img-55.png" alt="magzin" class="cover-image">
                                            </a>
                                            <a href="#" class="badge bg-1 fs-8">Technology</a>
                                        </div>
                                    </div>
                                    <div class="card-corner @@corner-bg-color no-border">
                                        <a href="single-3.html" class="arrow-box">
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-9.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Culture</a>
                                            </div>
                                        </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-10.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Education</a>
                                            </div>
                                        </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-11.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Lifestyle</a>
                                            </div>
                                        </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-12.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Technology</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body mt-4">
                                        <a href="single-3.html" class="hover-underline">
                                            <h6 class="card-title mb-0">Cryptocurrency in 2025: Innovation or Illusion?</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-16.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Culture</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body mt-4">
                                        <a href="single-3.html" class="hover-underline">
                                            <h6 class="card-title mb-0">10 Places You Must Visit Before You Turn 30</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/page/img-85.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Education</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body mt-4">
                                        <a href="single-3.html" class="hover-underline">
                                            <h6 class="card-title mb-0">Minimalism in Design: Why Less is Still More</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="article card-5">
                                    ...
                                    <div class="card-body mt-4">
                                        <a href="single-3.html" class="hover-underline">
                                            <h6 class="card-title mb-0">The Global News You Might Have Missed This Week</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-17.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Technology</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body mt-4">
                                        <a href="single-3.html" class="hover-underline">
                                            <h6 class="card-title mb-0">What’s Trending Around the World Right Now</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/other/img-other-4.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Culture</a>
                                            </div>
                                        </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/page/img-70.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Education</a>
                                            </div>
                                        </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/page/img-100.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Lifestyle</a>
                                            </div>
                                        </div>
                                ...
                                <div class="article card-5">
                                    <div class="post-link">
                                        <div class="hover-effect-1">
                                            <div class="position-relative card-img-top thumbnail">
                                                <a href="single-3.html">
                                                    <img src="/assets/imgs/page/img-101.png" alt="magzin" class="cover-image">
                                                </a>
                                                <a href="#" class="badge bg-1 fs-8">Technology</a>
                                            </div>
                                        </div>
